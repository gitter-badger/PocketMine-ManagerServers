Module VersionSoft
    ...
    Sub VersionSoft(ByRef chooseserver As String, ByRef soft As String, ByRef checksoft As Object, ByRef checkphar1 As Object, ByRef checkphar2 As Object, ByRef path As String(), _
